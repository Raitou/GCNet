...
Esses 4 bytes do conteúdo dos payloads comprimidos (no nosso caso, marcados de verde) são o tamanho **descomprimido** da parte comprimida. Note que esse segundo tamanho é em little-endian, havendo aí uma exceção.
